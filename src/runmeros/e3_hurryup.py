...
def sc_accident(w: World):
    ...
    return w.scene("電車は事故で止まってしまい",
            ...
            sana.be("その一時間後、$Sは吊り革に手が届かない自分の身長を嘆くでもなく、八割くらい埋まった電車の中でスマートフォンを手にこの世の終わりみたいな顔をしていた"),
            man.be(),
            sana.explain("あの後すぐに$fukayaは救急車で病院へと運ばれていった",
                "担架に載せられながら何度も「先生のことお願い」と繰り返し、$Sの手をぎゅっと握り返してくれたその感触が、温もりが、まだ残っている"),
            _.explain("動き出したその振動に足を踏ん張りながら$Sは改めて引き継ぎ資料に目を通す。どうやら今日の午後一時には原稿を取りに行くと約束したことになっているみたいで、",
                "現時点で既に十二時三十五分", "$noto先生のアパートがある三鷹まではまだ十分以上かかるし、駅からも徒歩十五分と書かれていたことから、",
                "暗雲が垂れ込めているのだ"),
            sana.think("走れば間に合う走れば間に合う走れば間に合う――と、心の中で三回唱える",
                "そういえば緊張した時に飲む人の字も流れ星に願う時もどうして全部”三”なのだろうか",
            ...
            sana.think("引き継ぎ資料には『$noto先生は気難しく、特に約束した時間や待ち合わせで先生の機嫌を損ねないことは困難を極める』と注意書きしてあるくらいの、",
                "難敵らしいのだ"),
            sana.do("$Sはスマートフォンで他の経路を急いで確認する",
                "他の路線に乗り換えて迂回する案もあったがどれも時間的に余裕がない",
                "五分後に動き出したとして、すぐ隣の駅で降りてからタクシーというのが無難な線だろう"),
            sana.do("けれど一分待っても二分待っても何のアナウンスもなく、動き出す気配も感じられない",
            ...
            sana.talk("運転再開とかいいから、ちょっと降ろして！", "降ろして下さい！"),
            camera=w.sana,
...
def sc_rungirl(w: World):
    ...
    return w.scene("彼女は走る",
            ...
            sana.think("がんばる自分を文芸の神様は見捨てなかったのだ！",
                "――こういう時はそう思うことにしている"),
            ...
            oldlady.talk("お嬢ちゃん、ママは一緒じゃないの？"),
            sana.talk("これでも成人してます！"),
            oldlady.talk("あらまぁ、すみませんねぇ"),
            sana.do("お構いなく。慣れてますので、と精一杯の笑顔を作り、その女性が乗り込んだタクシーを見送ると、$Sは草の生えたコンクリートブロックの上に特大の溜息を叩きつけ、顔を上げる"),
            sana.think("――よし、少し走るか"),
            sana.do("次のタクシーを待つ",
                "そんな選択もあるだろうけれど$Sは走ることを選んだ",
                "今更少しくらい走ったところで何も変わらない",
                "もう遅刻は確定的だ",
                "でも思うのだ",
...
def sc_timelimit(w: World):
    ...
    return w.scene("タイムリミット",
            ...
            sana.explain("あの後、交差点まで出て何とかタクシーを捕まえることができたのは良かったが、それでも三鷹までの料金は高くついた",
                "経費では落としてもらえないだろうと覚悟しつつ一応領収書を貰っておいたけれど、今月は出費が多くあまり財布事情は宜しくない"),
            ...
            sana.talk("あれかな？"),
            sana.do("角を曲がったところで新築の三階建てマンションに挟まれる形で、二階建ての、外にところどころ錆びついて見える鉄の階段が付いた木造アパートが見つかった"),
            sana.think("ちょっと遅れたけど許容範囲かな、","と既に三十分は遅刻をしていることを確認してから、小走りで向かう"),
            gate.look("入り口の門に『$on_hisapart』という木の看板があり、それが十五度ほど傾いていた"),
            sana.think("確かにここだ", "&"),
            sana.think("放火でもされたら一気に燃え上がりそうだと感じつつも、一〇三号室の前へと足を進める"),
            ...
            door.look("そこに書かれていたのは『編集よ去れ！』という一言だった"),
