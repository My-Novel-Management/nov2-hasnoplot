...
def sc_rejection(w: World):
    ...
    return w.scene("編集拒否",
            ...
            sana.do("ドアを叩き、大声で呼びかけてみるが、返事どころか物音一つ聞こえてこない",
                "ひょっとすると不在なのだろうか、という思いで続ける"),
            _.talk("あの、先生！　お願いします！", "とにかく中に入れて下さい！", "お願いします！"),
            sana.do("何度か呼びかけてみるが、ドアを叩く度に「不在かな」という思いが強くなる",
                "それでももう一度だけと思い、$Sは息を吸い込んだ"),
            sana.talk("あの！　先――"),
            sana.do("何だろう。$Sはドアに耳をつけ、中の音を注意を向ける",
                "微かに、カタ、と音がした", "&"),
            _.think("やはり中にいるのだ", "&"),
            ...
            noto.look("ようやく$CSの前に姿を現した$full_notoは小柄な彼女でなくても見上げるような巨漢だった",
                    "その大男がちんまりとしたテーブルの前で立ち上がって驚いている",
                    "藍染の作務衣でそのがっちりとした体を包み込み、岩を削って作ったのかと思えるような堀深いしっかりした顔つきだ",
                    "無精髭の生えた顎の上で口をへの字に曲げ、その太眉を顰めていたが、意外と目は小豆のような円さで、", "&"),
            sana.think("そのギャップからだろうか、",
                    "$Sには不思議といつものような恐怖心は芽生えなかった"),
            noto.talk("さようなら"),
...
def sc_takeoff(w: World):
    ...
    return w.scene("脱げ編集者",
            ...
            sana.explain("何とか頼み込んで中に入ることだけは許してもらえた$Sだったが、",
            ...
            noto.talk("いいから脱げ"),
            noto.do("先生は腕組みをして$CSを睨みつけたまま、険しい表情で何度も繰り返す"),
            ...
            _.explain("この場合、最も良いのはＡで、そこから順にＢ、Ｃと落ちていく",
                    "だからここで言うＳとはＡの上、｜Ｓｕｐｅｒ《スーパー》の意味ではなく、最悪のＳだった", "&"),
