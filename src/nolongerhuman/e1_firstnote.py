...
def sc_notintime(w: World):
    ...
    return w.scene("間に合わないことが決定",
            ...
            sana.talk("ああぁぁ……"),
            _.do("$Sは大脳が困り事で満たされた思いになり、頭を抱えてその場にへたり込んだ"),
            ...
            sana.talk("心配しなくていいわよ", "普通はそんなことしないし、責任取るとしても本来は上司、つまり王自身だからね",
                "ただあの王なら難癖つけてやりかねないってだけ"),
            sana.think("ただ$Sの心配はそんなことよりも先生の作家生命に向いていた",
            ...
            sana.think("原稿が締め切りまでに書き上がらなければ今回の出版の話は流れる、と言われたことを思い出し、",
                "とりあえず短編の時みたく自分の今書いているものをダミーで提出しておくかなと一瞬邪な考えが浮かんだが、",
...
def sc_mynovel(w: World):
    ...
    return w.scene("とにかく自分の作品を",
            ...
            sana.explain("実は普段はあまりこういった場所でパソコンを広げることは少ない",
                "もっと落ち着ける雰囲気の喫茶店か、周囲を気にしなくていいカラオケボックスを使うようにしている",
            ...
            sana.explain("物語は$Sが書いた短編小説の出来損ないの設定を更に膨らませたものになっていて、",
                "無限の命を持つ女王が一度滅びてしまった世界を自分の思い通りに新生しようとする、創造譚だ",
                "ビルド系の話の需要も昨今高まっているので、その流れに乗る形で短編の不死の女王に取り込んでみた"),
            ...
            yuza.talk("へえ、奇遇ですね"),
            sana.talk("あ……"),
            sana.do("$Sは顔を覗き込むようにテーブルに近づいてきた$yuzawaを見て、慌ててパソコンを閉じる"),
            sana.talk("まだ先生の盗作の件を追いかけてるんですか？", "何度も言いましたけど先生は絶対そんなことしませんから",
                "それにご存知でしょうけど今は火傷で入院中なんです", "こんな金にもならないお話を追いかけるよりも政治家の汚職の一つでも暴いて下さいよ"),
            yuza.talk("相変わらずぺらぺらと口だけは動くねえ", "邪魔するよ"),
            sana.talk("いえ。ほんとに邪魔なんでやめて下さい"),
            yuza.talk("なあに、すぐ終わるさ", "そういや先生んちの放火犯、指名手配されたよ", "$full_noseって言ってたが知ってるか？"),
            sana.think("先生の元弟子だ", "一度家まで乗り込んできたことを思い出し、$Sは小さく膝が震えた"),
            yuza.talk("まあいいや","それより、あんたこの前証拠なんかないって言ってたよな？",
                "これ、来週号のゲラなんだが……"),
            sana.do("$yuzawaが$Sの前に投げたのは荒い白黒刷りの週刊誌紙面案だ", "そこには手書きの原稿用紙と先生のデビュー作の書籍を並べた写真があり、",
                "『疑惑の盗作作家その真実』というタイトルと、写真の原稿が$tsuruの持ち込み原稿のコピーだと書き記されていた"),
            sana.talk("これ、どうしたんですか？"),
            yuza.talk("色々とツテがあってね", "後であんたのとこにも一部分だけだが持ち込み原稿のコピーを送るよ",
                "それを先生に見せて本当に盗作してないのかどうか、聞いてみればいい"),
            sana.talk("そんなこと！"),
            yuza.talk("読めば分かるよ。中身、そっくりだぜ。双子みたいに"),
            yuza.go("$yuzawaは口元にいやらしい笑みを浮かべ、行ってしまう"),
            sana.talk("あの野郎……"),
            man.come(),
...
def sc_masterletter(w: World):
    ...
    return w.scene("先生の手紙",
            ...
            sana.explain("先生宅が火事に遭ってから十日が経っていた",
                "結局何も進歩がないまま明日に締め切りが近づき、$Sは湯船の中で思い切り「もう駄目ー！」と叫んでいた"),
            ...
            sana.do("キーボードに手を置く",
                "脇に置いた先生の創作ノートをぺらぺらと捲ると、その隙間に挟まっていた古い封筒が目に入った"),
            sana.talk("何これ……"),
