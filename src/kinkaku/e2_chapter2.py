...
def sc_talkaboutthreaten(w: World):
    ...
    return w.scene("脅迫状について",
            noto.do("その十分後、先生の手が$CSの右手をしっかりと握っていた"),
            noto.talk("どうだ。上手いもんだろう？"),
            sana.do("しかし得意げな言葉とは裏腹に$Sの右手の人差し指にできた蝶々結びは先生の掌くらいでかい",
            ...
            sana.explain("いつから作家は小説以外にもこんなに多くのタスクを求められるようになってしまったのだろうと、一度$fukaya先輩とも話したことがあるが、",
                "本が売れなくなってきているという経済状況以上に作家も作品も増えすぎて、パッケージ以外の個性を求められているんじゃないか、ということにその時は落ち着いた"),
...
def sc_pulils(w: World):
    ...
    return w.scene("弟子について",
            ...
            sana.come("#先生に連れられてやってくる",
                "そこは$fukayaのメモに書かれていた先生お気に入りの駅前のバーだった"),
            utsu.be("#グラスを磨いている"),
            inside.look("路地から低くなった場所にビールジョッキを模した黒い看板が掛かる",
                "地下一階部分まで石段を注意して降り、シックなグリーンのドアを開けて中に入ると、営業しているのかどうか分からないくらい薄暗い",
                "間接照明が足元を照らし、グラスを磨いている白髭のマスターが「どうも」と挨拶をした"),
            sana.do("$Sは軽く会釈をし、先生に続く", "&"),
            _.think("温和な見た目なのに全てを見抜いているかのような泰然としたマスターだ",
                "$Sは少し苦手だと感じた"),
            ...
            sana.do("先生がそう言うので、$Sも「はい」と頷き、わざわざ「洋風」と冠されたそのオムライスと対峙する",
                ...
                "割ってみると中身もチキンライスで、味は少し甘めになっている",
                "美味しいというよりも懐かしいという感想が先に浮かんできて、",
                "そういえば以前も同じようなことを思わなかっただろうかと、そんなことを考えながら口の中で溶け合う卵とご飯のハーモニィを感じた"),
            noto.do("先生も満足そうに時折目を閉じて笑みを浮かべている",
                "おそらく金沢の故郷のことでも思い出しているのだろう").omit(),
            w.br(),
            ...
            noto.talk("彼はね、文章は並、アイデアは凡庸、特別な感性もなければ、社会に対しての批評性や作家としての矜持のようなものも何もなくてね、",
                ...
                "小説に限らないが、勉強する時には名作と呼ばれるものを一旦自分で書き写してみると良い",
