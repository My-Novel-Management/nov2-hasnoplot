...
def sc_intimidation(w: World):
    ...
    return w.scene("脅迫",
            ...
            noto.talk("へえ、知ってたのか",
                "あの人から何か聞いたか", "まあいい",
                "あんたの家すぐそこだろ？　お茶くらい出してくれや", "ゆっくり話したいことがあるんだよ、あの人の盗作についてな"),
...
def sc_manstalk(w: World):
    ...
    return w.scene("男の話",
            ...
            nose.talk("あの人には本を出す資格なんてない",
                "何度もそう警告したのに無視するお前らが悪い"),
            w.eventEnd("沙奈のストーカー"),
            sana.think("その発言はストーカーや脅迫行為を認めたも同然だった"),
            sana.talk("何故そこまで先生に拘るんですか？", "そもそも先生は盗作なんて"),
            ...
            nose.talk("ある記者に、見せてもらったんだ",
                    "あの人が盗作したって人の原稿を",
                    "デビュー作『$masternovel1』にそっくりだったよ", "その上、あの人が書いた文章よりもずっと洗練された、素晴らしい作品だったんだよ！",
            ...
            sana.do("そのまま$noseは$Sを押し倒し、馬乗りになる",
                    "その表情は明らかに平常心を失っていた"),
            sana.talk("やめて、お願い……"),
            sana.do("$noseの顔が迫る", "荒く吐く息が、$Sの喉を気持ち悪さで締め上げる"),
            sana.hear("その時、インタフォンが鳴らされた"),
            nira.talk("おーい"),
            sana.talk("$nirasakiさん！"),
            nose.talk("邪魔が入ったか"),
            nira.come("ドアを開けて入ってきたのはグレィのミリタリジャケットを着た$Sだった"),
            ...
            nira.talk("近々週刊誌に盗作の話が出るってネットで騒ぎになってる",
                    "その作者は、お前の担当の先生だ。$notoだよ"),
            sana.talk("え！？"),
            stage=w.on_herhouse,
            )
