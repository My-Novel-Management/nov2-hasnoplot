...
def sc_aboutmaster(w: World):
    ...
    return w.scene("先生について",
            ...
            sana.do("$Sは慌てて先輩の引き継ぎメモの中にその記述を探したが、絶版だとはどこにも書かれていない",
                    "ただ重要事項として赤いアンダーラインが引かれた文章があり、『ただし先生は十年間、一冊の小説も出版していない』と書かれていた"),
...
def sc_aboutnovel(w: World):
    ...
    return w.scene("吾輩は猫である",
            ...
            noto.talk("その件で精神を病んだ漱石に高浜虚子が小説を書くよう勧めて書き上げたのが、あの猫の目線で人間生活を切り取った傑作だったのだよ"),
            ...
            noto.talk("小説に起承転結構造が必須という訳ではない",
                "しかし君、", "物事には何でも順序がある",
