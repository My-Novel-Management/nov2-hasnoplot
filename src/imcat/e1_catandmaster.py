...
def sc_cannot(w: World):
    ...
    return w.scene("脱ぎません",
            ...
            noto.talk("そう"),
            noto.do("テーブルを前に胡座をかく藍染の作務衣姿の男性は顎を撫でるように指でやり、つまらなそうに吐息を出す",
                "その膝の上にひょい、と太った黒猫がやってきて丸まった"),
            noto.talk("それじゃあ、君、出ていっていいよ"),
            noto.do("そう言うと先生は$CSに興味を失ったように視線を膝の上の黒猫へと向けた",
                "ただ撫でられている側はあまり心地が良くないのか、もぞもぞとその大きな手から逃れようとする"),
            sana.talk("わたくし、本日より$fukayaの担当を引き継いで先生の編集になりました$full_sanaです",
                "宜しくお願いします"),
            sana.think("ちら、とも見る様子がないが、そんなことをいちいち気にしていたら仕事にならない",
                "作家というのは偏屈な人間が多いと聞いているし、まだ作品を一ミリも読んでいないけれどライトノベルではなく文芸畑の先生なのだ",
            ...
            sana.talk("実は本日、$fukayaと共に先生に引き継ぎのご挨拶に伺う予定だったのですが、$fukayaが体調を崩してしまい、",
                ...
                "どうぞ、ご確認下さい"),
            sana.do("バッグから先輩直筆の手紙が入った封筒を取り出し、おずおずとテーブルまで膝で歩いていってそっと置くと、確認するように先生の顔を見てから黙って下がった"),
            noto.talk("$fukaya君から？"),
            noto.do("訝るように唸りつつその手紙を取り出す", "先生はそれを開き、一応目を通してくれるようだ", "&"),
            sana.explain("そこには産休に入ることや最後まで仕事を手伝えないこと、また$Sのことは頼れる後輩だと書いておいてくれたことは聞かされているが、",
                "実際に中に何と書いてあったのかは確かめてはいない",
                "&"),
            noto.do("それでも先生は小さく何度か頷くと、顔を上げて口を開いた"),
            ...
            noto.talk("君は顔を合わせた早々にパイを投げつけるようなことを言って、そういうものを無作法だとは思わないのかね？"),
            ...
            noto.talk("手紙には確かに$fukaya君の後任だと、彼女の直筆で書かれていたよ",
                "しかしだね、$fukayaさんは出会って五分と経たないうちに作者から原稿を取り立てようなどという、野蛮な人間ではなかった",
                "そもそもまだ$meは君を担当と認めた訳ではない",
                "だからただ彼女と同じ会社の人間というだけの君に原稿を渡す義理などないのだよ"),
            sana.think("ああ、この作家駄目だ",
                "出会ったすぐから屁理屈を並べて原稿を出し渋るというのは人間性もそうだが何より基本的な礼儀がなっていない、最悪のＳランクであることは間違いない"),
            noto.talk("そもそも君、編集やってどれくらいになるの？",
                "とても$fukayaさんのようなベテランとは思えないのだが"),
            sana.talk("別の編プロにいたので月刊誌を一年ばかり作ってました",
                    "$on_hercompanyに移ってからはまだ二ヶ月ほどですね"),
            noto.do("それを聞いて先生は大きく頷く"),
            ...
            sana.do("ガサゴソと音がするので何をしているのかと覗きに行くと、どうやらコーヒーを淹れようとしているようだ",
                    "ただフィルターを置いた上にそのままコーヒーの粉を振りかけ、適当に付属のポットに入れた水を注ぎ入れ、コーヒーメーカーのセットを終わらせようとしている"),
            ...
            noto.do("先生は新聞を置き、その円な瞳を$CSと猫に向ける"),
            sana.talk("名前は何と言うんですか？"),
            noto.talk("そいつの名前は$mascat"),
            sana.talk("そっか、名前ないのか", "じゃあお前も新人だねえ"),
            sana.do("しゃがみ込み、顎を撫でてやるとゴロゴロと喉を鳴らした",
                    "今住んでいるところはペット不可だが、同居人の一人がいずれは猫を飼えるところに引っ越したいと言っていて、偶に猫カフェに連れて行かれる",
                    "毎日というと世話が大変そうだけれど、こうして時々触れ合うのは嫌いではない"),
