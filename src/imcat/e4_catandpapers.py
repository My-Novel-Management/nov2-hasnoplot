...
def mo_searchmaster(w: World):
    ...
    return (
            w.scene("先生を探す",
                ...
                sana.do("何故自分は通行人から奇異な視線を向けられながら先生を探しているのだろう、と横断歩道の信号待ちで立ち止まり、ふと冷静になって考えてしまった",
                    "そもそも勝手にどこかに行ってしまった作家を探さなければならないという決まりはないし、",
                    "そこまでして今日是が非でも先生の手から原稿を毟り取って来なければならない訳でもないのだ"),
                sana.talk("やめようかな"),
                ...
                sana.think("最初に資料を見た時は嘘だろうと思ったけれど、本当に機械と呼べる類のものは$tvやエアコン、冷蔵庫に電気ポットくらいなもので、",
                    "あれでよく現代人をやっていられるなと逆に感心したくらいだった",
                    "しかし携帯さえあれば簡単に捕まえられるという常識が通用しないのは、編集から体よく逃げ出したい作家にとっては寧ろ好都合なのかも知れない"),
...
def sc_heymaster(w: World):
    ...
    return w.scene("先生を見つけて",
            ...
            sana.do("タクシーを見送ってアパートの一階を見た時だった",
                "$Sの視界は先生が玄関のドアを開けて中に入っていく後ろ姿を捉えたのだ"),
...
def sc_nousepc(w: World):
    ...
    return w.scene("パソコンがなくても",
            ...
            sana.talk("はい、分かりました"),
            sana.do("そう答えておいて、$Sは引き戸を開ける"),
            noto.talk("おい！"),
            sana.talk("あー、もう、先生って脱いだものそのままにしておくタイプですね"),
            ...
            sana.do("$Sは気にせずずかずかと足を踏み入れると、どこかにノートパソコンでも隠してあるんじゃないかと探し始めた"),
            noto.talk("おい、君"),
...
def sc_nobaggage(w: World):
    ...
    return w.scene("手荷物すらなく",
            ...
            sana.do("オフィスに戻る$Sの足は、一日歩き回っていたという訳でもないのに既に疲労困憊の悲鳴を上げていた"),
            yone.talk("おかえりさん"),
            ...
            sana.talk("$me、たぶん無理です、あの先生",
                "今まで一人で担当したことなかったですけど、それにしても今までに会った作家さんたちは癖があってもみんな真面目だったんだなって分かりました"),
            yone.do("$Sはペットボトルの健康茶を一口含み、$CSを一瞥しただけだ"),
            sana.talk("あの、$yonezawaさんはどうしてるんですか、合わない作家の担当になった時って"),
            yone.talk("仕事ですからね", "ひたすらビジネスライクに徹するだけですよ"),
            sana.talk("ビジネスライクかぁ……"),
            sana.think("すぐに頭に血が上ってしまう自分には一生縁遠い言葉だと、$Sは目を閉じて顔を伏せた"),
            ## NOTE
