...
def sc_station(w: World):
    ...
    return w.scene("新幹線のホームにて",
            ...
            noto.be("#軽装で立っている"),
            noto.do("エスカレータで先に上がっていた$notoは、ロングコートを吹き込む風に靡かせつつ彼女の姿を見て、首を振る"),
            ...
            sana.do("$Sも別に怒りたい訳ではないし、どうせなら気分よく取材旅行といきたかったが、",
                "昨夜は明け方まで$geroの相談に乗っていた所為で、まだ脳の細胞が興奮状態を半分維持したような心地なのだ"),
            sana.talk("とにかく締切は伸ばせませんからね？", "分かってますか？"),
            noto.talk("分かっているよ","それにね、$meは一度として原稿を落としたことはないんだ"),
            ...
            sana.do("新幹線がホームに滑り込んでくる", "土曜日だからか見える範囲ではほぼ満席のようだ",
                ...
                "実際$Sも読まなければならない原稿や小説を詰め込んだ為にこんな大荷物になっているのだが、",
                "城崎までの時間を考えればその内のいくつかは消化できるだろう、という甘い期待もあった"),
            ...
            sana.explain("こうして取材という名目で一泊二日、城崎に旅行に行くことになったのだった",
                "正直不安と焦りしかない"),
            w.eventStart("城崎旅行"),
            ## NOTE
...
def sc_kinosaki(w: World):
    ...
    return w.scene("城之崎",
            ...
            momo.come("と、目の前に慌てたように停まったワゴン車から藤色の着物姿の女性が降りてきて、$CSたちで目を留めた"),
...
def sc_inkinosakitown(w: World):
    ...
    return w.scene("城崎の町中",
            ...
            sana.talk("旅行よりも食べ物の特集ばかりだったんで、都内や、遠くでも関東か東海道線がいいとこでしたよ",
            ...
            sana.think("確かにその企画は評判が悪く、$Sたちがたこ焼きを満喫しただけが収穫だった"),
...
def sc_atinn(w: World):
    ...
    return w.scene("宿に二人",
            ...
            take.look("髪の毛をしっかりと後ろでまとめた眉の凛々しい女性が、丁寧に指をついて$CSたちを出迎えてくれた", "&"),
