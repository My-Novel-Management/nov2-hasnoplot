...
def bk_aboutnovel(w: World):
    ...
    return (
            ...
            w.block("プロットとは",
                ...
                _.talk("だがミステリだとトリックから逆算して作ることになるからとにかくまずプロットを作るということになる"),
            ...
            w.block("シーンについて",
                ...
                sana.do("なるべく見ないように顔を背けつつガラス戸が手を伸ばし、泡が零れそうなコップを手渡す",
                    "先生は特に気に掛けた様子もなく腕を伸ばしてそれを受け取り一口飲むと、脇に置いた"),
                noto.talk("プロットはお話のまとまりで考えるから、厳密に考えるとシーンはまた違うものだね",
                    "シーンというのは場面、つまり場所と時間をベースとした概念だ"),
                sana.think("半分徹夜明けみたいな頭ではぼんやりとしか理解が追いつかないが「はい」と頷いて次を促す"),
                ...
                noto.talk("記事を書く時の基本となる５Ｗ１Ｈのような、物事を理解する為の最低限の情報が入っているか、というのを意識する為にもシーンという考え方を持っておくと良いんだよ"),
