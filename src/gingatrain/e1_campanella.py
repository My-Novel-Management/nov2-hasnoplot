...
def sc_whereishe(w: World):
    ...
    return w.scene("先生はどこへ？",
            ...
            _.think("銀河鉄道の夜のジョバンニもこんな気持ちになったのだろうか、と考えるくらいには、酷く混乱していて、",
...
def sc_investigation(w: World):
    ...
    return w.scene("先生の捜索",
            sana.come("それから三十分、五分でメイクを終えてポーチにスマホと財布を放り込んで慌ててタクシーを捕まえ、病院に急いだ"),
...
def sc_writervisit(w: World):
    ...
    return w.scene("記者さんお願い",
            ...
            yuza.talk("相変わらずうるさいな、あんた。それより送りつけたアレは楽しんでもらえたかい？",
                "こっちは全部のコピー持ってるかな。あの作家先生がどれだけ否定したところで第二第三の弾がある",
                "もしインタビューさせてもらえるなら、今週掲載予定の分は見送ってもいいとデスクも言ってるけど、どうだ？"),
