...
def sc_find_mymaster(w: World):
    ...
    return w.scene("先生を見つけ出した",
            ...
            sana.talk("彼に許してもらう為十年間、毎月十三日にここにお参りしていたんでしょう？",
                "彼の声は、聞けましたか？"),
            ...
            sana.do("$Sは声にはせずにもう一度首を横にして否定すると、ハンカチを取り出して彼の涙を拭うと、落ち着かせるように優しい声でこう切り出した"),
...
def sc_truth_hissuicide(w: World):
    ...
    return w.scene("彼の自殺の真相",
            ...
            sana.talk("いつもあんな感じですけど、結構助けられてます",
                ...
                "小説を読むまで気づきませんでした", "ああ、そうか", "先生の小説ですよ",
                "$meに教室の狭さと世界の広さを教えてくれたのは"),
            noto.talk("さて、そんなものを$meが書いていたかな"),
            noto.look("謙遜だろう", "それでもどこか嬉しそうにして部屋を見回している"),
            sana.talk("先生、これを、まずは読んでみて下さい"),
            noto.talk("君の小説……ではないね", "何だろう"),
            sana.do("$Sは答えないまま封筒の中身を取り出して先生に手渡す", "&"),
            noto.have("端が黄ばんでいる古い原稿だ", w.carryingpaper,
                "それが二百枚はあるだろうか","&"),
