...
def sc_find_mymaster(w: World):
    ...
    return w.scene("先生を見つけ出した",
            ...
            noto.talk("どうしても彼に見せておきたかったんだ"),
            noto.do("その手には分厚い茶封筒があった"),
            sana.talk("隠してあったんですか？"),
            noto.talk("昔からの癖でね", "コピーを取っておくんだよ"),
            sana.talk("何故原稿はもうないなんて嘘を？"),
            noto.talk("オリジナルの方は本当に燃えてしまったから、そう言っただけだ"),
            sana.talk("でもコピーが残っていることを黙っていた。そのせいで先生の出版枠は完全に亡くなったんですよ？"),
            sana.talk("原稿は子どものように大切なものだって先生言ったじゃないですか？", "それが出版されない、誰にも読まれない不幸を、親が選ぶんですか！"),
            noto.talk("$meは彼を死に追いやった", "彼の許しがなければ作家として書いてはいけないんだよ！"),
            sana.talk("先生。それは違います"),
            noto.talk("君は何も知らない。何も分からない。作家のことなど、何も"),
            sana.talk("ほんとに分かってないのは先生の方じゃないですか！"),
...
def sc_truth_hissuicide(w: World):
    ...
    return w.scene("彼の自殺の真相",
            ...
            sana.talk("ここで待ってて下さい"),
            sana.talk("ごめん。ちょっとだけ使わせて"),
            sana.do("それぞれの部屋に引っ込んでもらう"),
