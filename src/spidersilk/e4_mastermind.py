...
def sc_makedifficult(w: World):
    ...
    return w.scene("ごねる先生",
            ...
            noto.do("強い眼差しで先生を見上げる$CSに対して、彼は怒られたゴリラみたいなつぶらな瞳を何度か瞬かせ、特大の溜息を落としてからリビングへと戻って行った",
...
def sc_writingterm(w: World):
    ...
    return w.scene("何故か沙奈も書くことに",
            sana.be("先生が準備した軽食をすっかり食べ終え、食後のコーヒーまで満喫しているのを、$Sは正座したままじっと見つめていた"),
            noto.be("#机の前で腕組みしている"),
            noto.talk("ねえ$sana君",
            ...
            _.explain("一冊の本に掛かるコストは、ただ作家の原稿料や印刷代だけではない",
                ...
                "ものによっては何年も掛かる場合がある",
                "その苦労を知っているからこそ、一冊一冊が以前よりもずっと愛おしく、$Sは感じていた"),
