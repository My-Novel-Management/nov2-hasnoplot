...
def sc_noplot(w: World):
    ...
    return w.scene("プロットはない",
            ...
            sana.talk("先生、原稿を"),
            noto.talk("ない"),
            sana.think("そんな思いで玄関のドアを開けて入る度に笑顔で口にするのだけれど、決まってそんなやり取りが繰り返される"),
            sana.talk("先生"),
            noto.talk("ない"),
...
def sc_lunchtime(w: World):
    ...
    return w.scene("ランチタイム",
            ...
            noto.do("$CSが対面に座るなり、その顔を覗き込むようにして得意げに先生は言うと、注文を取りにやってきた先程挨拶した女性からおしぼりを受け取って、それを広げ、顔を拭う"),
...
def sc_lightnovel(w: World):
    ...
    return w.scene("ライトノベル",
            ...
            sana.talk("あ、すみません", "どうしても編プロ時代に月刊誌で食べ物系特集をやっていた頃からの癖で"),
...
def sc_novelvalue(w: World):
    ...
    return w.scene("小説の価値",
            ...
            sana.talk("$meは編集者で、先生は作家です",
                "小説以外に話すことなんてありますか？"),
            noto.do("そう言い放った$Sを一秒ほど見やった後で先生は小さく首を横に振る"),
            ...
            sana.do("店の客には遂に$Sと先生の二人だけになったが、彼女には特に沈んだ様子も見られない"),
