...
def sc_disturbing(w: World):
    ...
    return w.scene("不穏",
            ...
            sana.think("なぜ先生が$Sに友人の遺書を見せたのか、自分が彼を殺したと口にしたのか、その意味についてずっと考えていた",
                "あの遺書を見た時にまず頭に浮かんだのが夏目漱石の『こゝろ』という作品だ",
                "知人の遺書を手にする、というその気持ちを想像すると、何とも居た堪れない",
                "&"),
            sana.think(
                "それにしても最近の先生は少し妙だ、と感じる",
                "ただその違和感が徐々に$Sに対して心を許してきてくれているということであるなら、少し嬉しい"),
            sana.talk("ん？"),
