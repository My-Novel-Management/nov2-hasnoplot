...
def sc_kanazawa(w: World):
    ...
    return w.scene("金沢に向かう",
            sana.be("#新幹線に乗っている"),
            w.comment("県境の長いトンネルを抜けると雪国であった。夜の底が白くなった。信号所に汽車が止まった。／向側の座席から娘が立って来て、島村の前のガラス窓を落した。雪の冷気が流れ込んだ。娘は窓いっぱいに乗り出して、遠くへ叫ぶように、／「駅長さあん、駅長さあん」"),
            sana.explain("県境の長いトンネルを抜けるとそこは、本当に雪国であった",
                "気分の底が白くなった", "通過駅の表示が止まり、通路を挟んで向かい側の席に座っていた娘が立ち上がる", "「窓開かないね」と言ったのに母親らしき女性がこちらを見て苦笑した"),
            w.br(),
            sana.do("川端康成の『雪国』であれば汽車の窓を開けて流れ込む雪の冷気を感じるところだけれど、現代の新幹線にそういった趣はない"),
            outside.look("それでも車窓からは日本海の荒れる波の上に雪の粉が舞うのが見え、",
                "広がる野原はすっかり雪の毛布を被っているのが分かり、$full_sanaは思わず「さっむ」と口走った"),
            sana.do("車内は暖房も効いて、それこそ喉が乾いて仕方ないくらいだったが、",
                "三センチ積もるだけで大雪警報の出る都内で暮らしているとその真っ白な景色だけで充分に寒さを感じられた"),
            sana.do("前の座席に付いているテーブルを出し、その上に日記帳を広げる", w.sananote),
            sana.explain("そもそも何故新年明けて早々に新幹線で金沢に自分が向かうことになったのかといえば、", "&"),
            sana.explain("今彼女の鞄の中に出来たての雑誌見本があるからだ", w.magazine1_mihon, "&"),
            ...
            sana.talk("あ、$geroだ"),
            sana.do("スマートフォンにはカエルのスタンプと共にメッセージが入っている"),
            sana.do("シェアハウスの友人二人はどちらも正月はアルバイトが入っていて、今年も実家には帰らないらしい",
                "$Sも先生の担当で忙しくしていなければ今頃は名古屋だったろうが、楽しみにしていた祖母には悪いけれど何とか春の大型連休の何日かを帰省に当てて代わりにしたい"),
            ...
            _.explain("内容を簡単に表現するなら男女の三角関係を軸とした青春ものだった",
                ...
                "応募先のコンテストでは優秀作止まりだったがそれが編集者の目に留まり$on_Kawadeから出版される運びになったと、本に挟まれていた文芸誌のコピーに書かれていた"),
            ...
            _.explain("しかしライトノベルの編集から言わせてもらえれば、正直何度も読んで味わうようなタイプの文章や作品というのは可能ならば避けてもらいたい",
                ...
                "ライトノベルが今現在の地位を確立しているその最たる理由が、漫画やアニメの趣をそこに内包していることだった"),
            sana.do("一ページ読んでは考え、次のページを読んでは物思いに耽る"),
            ...
            _.explain("いつも心のどこかで二人を羨んでいた主人公だけが生き延び、自分の人生には満足していると語っていた友人と彼女は先に死んでしまったのだ",
                ...
                "いや、書かれていない訳ではないのだろうけれど、読者が考え、読み取ることを期待して、作中では明言されていなかった"),
...
def sc_welcome(w: World):
    ...
    return w.scene("先生の出迎え",
            ...
            sana.come("駅を一歩出ると、頭上をすっぽりと覆うパイプ状のものが幾重にも連なる『鼓門』と呼ばれるガラスドームに圧倒される",
                ...
                "$Sも資料用に写真に収めようとしたが、あまりに大きすぎてこれは写真にならないなと感じて止めた"),
            noto.come(),
            noto.talk("やあ、$sana君"),
...
def sc_masterhome(w: World):
    ...
    return w.scene("先生の実家",
            ...
            noto.do("先生は$CSの方を見ずにそう言うと、玄関の引き戸を開けて「ただいま」とだけ言った"),
            sana.talk("お邪魔します"),
            ...
            sana.do("二人の視線を受け、$Sの頬はできたての焼き芋の如くに熱々になった"),
            ## NOTE
            ##  先生の家の描写
            ##  写真は朝日が置いた
            stage=w.on_hishome,
