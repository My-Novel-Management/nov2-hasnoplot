...
def sc_inmasterhome(w: World):
    ...
    return w.scene("先生の家にて",
            ...
            tama.talk("全く"),
            tama.do("戻ってきた母親は$CSの斜向かいに座ると、一つ溜息をついてから表情を切り替え「じゃあ、食べちゃおうか」と笑いかけた"),
            camera=w.sana,
            stage=w.on_living,
...
def sc_unknownthings(w: World):
    ...
    return w.scene("知らないこと",
            ...
            sana.explain("結局あのまま先生の両親と$Sの三人だけで鯛を美味しくいただき、お腹が膨れて眠くなった頃に、先生が近所のファミレスへと連れ出した",
                ...
                "またあの酷い運転の車に乗るのかと一瞬覚悟したが、幸い歩いて行ける距離だったので食後の良い運動になっただけで済んだのは幸いだった"),
            ...
            noto.do("その言葉に先生は今年はじめの仏頂面を$CSに見せつけ、口元の汚れを紙ナプキンで拭う"),
            sana.talk("怒らないで下さいよ",
                "ほら、これ", "今日はこの為に来たんでした"),
